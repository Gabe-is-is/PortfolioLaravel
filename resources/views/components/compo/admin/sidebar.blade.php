<aside class="main-sidebar sidebar-dark-primary elevation-4">
  <a href="index3.html" class="brand-link">
    ...
    <span class="brand-text font-weight-light">Sybau</span>
  </a>
  ...
  <nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
      ...
      <li class="nav-item">
        <a href="{{ route('admin.contact.info')}}" class="nav-link d-flex align-items-center">
      ...
      <li class="nav-item">
        <a href="{{ route('admin.contacts.list') }}" class="nav-link d-flex align-items-center">
          <svg
          ...
          <p class="ml-2">
            Página de contatos recebidos - Em construção
          </p>
        </a>
      </li>
      <li class="nav-item">
        <a href="{{ route ('admin.disponibility.index') }}" class="nav-link d-flex align-items-center">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
      ...
      <li class="nav-item">
        <a href="{{ route ('admin.skills.index') }}" class="nav-link d-flex align-items-center">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
