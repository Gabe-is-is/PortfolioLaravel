<x-layouts::gest>
    ...
    <main>
        <h1>Projetos - Criar</h1>
        <form id="aboutForm" class="mt-4" method="POST" action="{{ route('admin.projects.store') }}"
            ...
            <div class="form-row ml-3 mr-3">
                <div class="col-md-12 mb-3">
                    ...
                    <input type="text" class="form-control" required name="link_demo">
                </div>
            </div>
            <div class="form-row ml-3 mr-3">
                <div class="col-md-12 mb-3">
                    <label for="link_code">Link Código</label>
                    <input type="text" class="form-control" required name="link_code">
                </div>
            </div>
            <div class="form-row ml-3 mr-3">
                <div class="col-md-12 mb-3">
            ...
            <div class="form-row ml-3 mr-3">
                <div class="col-md-12 mb-3">
                    ...
                    <input type="file" class="form-control" required name="imageble">
                </div>
            </div>
            <div class="w-full d-flex justify-content-end mr-3 ml-3">
                <button type="button" class="btn btn-primary mb-4 text-light" href="#" href="#" data-toggle="modal"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            Você tem certeza que deseja criar este Projeto?
                        </div>
